...
function take (opts, cb) {
  ...
  tmp.file(function (err, imgFilePath) {
    ...
    var onMessage = function (id, data) {
    ...
    this.send("say cheese", imgFilePath, opts)
 ...
 * [event, args...]
 * 
 * @param {String} event The message name
 * @param {...} args Arguments to pass along with the message
 */
Shoot.prototype.send = function send () {
  var args = [].slice.call(arguments)
    , msg = Array.isArray(args[0]) ? args[0] : args
