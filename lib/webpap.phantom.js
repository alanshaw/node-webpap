...
var args = ["msgFilePath", "url", "autoCheese"].reduce(function (args, name, i) {
...
function prepare (opts) {
  ...
  page.evaluate(new Function("opts", 'window.postMessage(opts, "*")'), opts)
}
...
page.open(args.url, function (status) {
  ...
  if (args.autoCheese == "true") {
    page.evaluate(new Function('window.addEventListener("message",function(e){if(e.data&&e.data.sender&&e.data.sender=="webpap.phantom"){window.callPhantom()}},false)'))
  }
